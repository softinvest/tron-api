...
use SoftInvest\TronAPI\FG\ASN1\Exception\NotImplementedException;
use SoftInvest\TronAPI\FG\ASN1\Universal\Set;

class RelativeDistinguishedName extends Set
{
    /**
     * @param string|\SoftInvest\TronAPI\FG\ASN1\Universal\ObjectIdentifier $objIdentifierString
    ...
    {
        /** @var \SoftInvest\TronAPI\FG\ASN1\ASNObject $firstObject */
