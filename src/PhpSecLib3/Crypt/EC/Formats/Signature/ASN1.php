...
namespace SoftInvest\TronAPI\PhpSecLib3\Crypt\EC\Formats\Signature;

use SoftInvest\TronAPI\PhpSecLib3\File\ASN1 as Encoder;
use SoftInvest\TronAPI\PhpSecLib3\File\ASN1\Maps\EcdsaSigValue;
